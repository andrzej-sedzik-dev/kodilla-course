...
class BoardTestSuite {
   ...
   /*
      ...
      Celem zadania jest obliczenie średniej liczby dni, jaka upłynęła od zlecenia wykonania zadania do dnia bieżącego.
      Uwzględniamy te zadania, które są aktualnie w trakcie realizacji. W tej sytuacji możemy użyć dwóch strumieni – jednego,
      aby obliczyć sumę, a drugiego, by obliczyć liczbę elementów. W wersji trudniejszej trzeba wykorzystać kolektor skalarny average().
    ...
    */
    ...
    void testAddTaskListAverageWorkingOnTask() {
        ...
        // Oblicz liczbę dni, jaka upłynęła od zlecenia wykonania zadania do dnia bieżącego
        // (Uwzględniamy zadania w trakcie realizacji)
        // utwórz pierwszy strumień, aby obliczyć sumę.
        // Utwórz drugi strumień, aby obliczyć liczbę elementów
